> このファイルは実装前に書いた設計書である。当時はこのリポジトリを dotfiles の
> サブディレクトリとして開発していたため、配置や公開方針の記述は現状と異なる。
> 現在の仕様は [README.ja.md](../README.ja.md) を参照すること。
...
```
196 46 21 226 201 51 208 118 27 199
214 82 39 220 165 50 202 154 33 129
190 48 57 93 197 45 213 159 87 228
```
